...
var loomSE = (function() {
    ...
    var status = {
        ...
        devOptions = {
            ...
            verbose: 'off', // reports errors, findings, events etc to console. Options are full | minimal | subtitles
    ...
    var gui = (function() {
        ...
        var id = 'gui',
            ...
            timeElapsed = helper.newElement('span', 'time_elapsed'),
            timeDuration = helper.newElement('span', 'time_duration'),
            ...
            btnPlayPause = new GuiComponent('div', 'btn_playPause', 'btn_sprite', ['play', 'pause']),
            ...
            btnSubtitles = new GuiComponent('div', 'btn_subtitles', 'btn_sprite', ['off', 'on']),
        ...
        function updateProgressBar() {
            ...
            timeDuration.innerHTML = getDuration;
    ...
    var Event = function(id, call, ignored, schedule, parameters) {
        ...
        var container = helper.newElement('div', id, this.class);
    };
